...
const getAppData = async (req, res) => {
    ...
    // console.log(new Date());
      ...
      const {genreId, free, time, time_value, id, appId, title, developer, released, released_value, checked } = req.query
      ...
      if (released || released_value) {
        ...
        switch (released_value) {
          ...
          case "$eq":
            ...
            let startOfDay = new Date(targetDate.getFullYear(), targetDate.getMonth(), targetDate.getDate(), 0, 0, 0, 0);
            let endOfDay = new Date(targetDate.getFullYear(), targetDate.getMonth(), targetDate.getDate(), 23, 59, 59, 999);
...
module.exports = {getAppId, addAppId, getAppData, getSimilarApp, smmEventsData, mongoService}