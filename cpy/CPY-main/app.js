...
// 4.引入路由
const conversationRouter = require("./router/conversation.router.js");
// const appidRouter = require("./router/appid.router.js"); // 仅测试脚本，与业务无关
...
app.use("/search", upload.none(), conversationRouter);
app.use(appidRouter);
